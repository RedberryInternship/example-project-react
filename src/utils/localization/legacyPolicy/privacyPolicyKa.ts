const html = `
    <ol style="margin: 0; padding: 0;">
      ...
      <li>
        ...
        <p>
          კომპანია აძლევს საშუალებას მომხმარებელს ისარგებლოს კომპანიის სერვისით, კერძოდ, აპლიკაციის საშუალებით მოძებნოს ელექტრომანქანის დამტენის ადგილმდებარეობა, გაიგოს დამტენის სტატუსი და ისარგებლოს ელექტრომანქანის დამტენით ელექტრომანქანის/დამუხტვადი ჰიბრიდის დასამუხტად, კომპანიის მიერ დაწესებული შესაბამისი დამტენის გამოყენების/სარგებლობის საფასურის სანაცვლოდ. ამასთან, აპლიკაციის საშუალებით კომპანიამ დროდადრო ან აპლიკაციის ან მოკლე ტექსტური შეტყობინებით შეიძლება შესთავაზოს მომხმარებელს სხვა სერვისებიც.
        </p>
      </li>

      <li>
        <div style="font-weight: bold;">
          მომხმარებლის უფლება-მოვალეობები
        </div>
