...
// Todo Vobi: This kind of default exports are bad practice
// Todo Vobi: You should name it useHome and change its file name to useHome 
// Todo Vobi: Hooks standard is that it should start with "use" keyword
export default (navigation :  NavigationScreenProp<NavigationState, NavigationParams>) => {
  ...
  } // Todo Vobi: remove unused function
  ...
  } // Todo Vobi: Split returned values vertically it is more readable and easier to modify
}