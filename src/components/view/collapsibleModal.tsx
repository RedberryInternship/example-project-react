...
import {GNOME, Const} from 'utils'
import {CustomSlideUpModal, MainSearchItem, PopupFilter} from 'components'
...
const collapsibleModal = forwardRef((props, ref: any) => {
  ...
  const renderHeaderComponent = () => (
    <View style={styles.headerComponent}>
      <Text style={styles.headerComponentText}>{t('home.allChargers')}</Text>
    </View>
  )
        ...
        <FlatList
          ...
          renderItem={({item}) => (
            <>
              ...
              />
              <MainSearchItem
                text={'ასფაawawdსფ ადს'}
                mainTitle={'ტბისლawdaისი'}
                onPress={() => {
                  Alert.alert('asdf')
                }}
              />
